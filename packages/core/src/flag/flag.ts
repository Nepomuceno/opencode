...
export const Flag = {
  ...
  // with a bundled snapshot of the models catalogue (see
  // packages/opencode/script/generate.ts and provider/models-snapshot.js).
  // To re-enable runtime fetching, set OPENCODE_DISABLE_MODELS_FETCH=false.
